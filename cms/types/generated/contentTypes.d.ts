...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Las 9 categorias del catalogo de recursos. El id (slug) no se debe cambiar: rutas y filtros dependen de el.';
...
export interface ApiDeviceDevice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Los dispositivos del ecosistema. El slug no se debe cambiar: las fichas de recurso lo referencian.';
...
export interface ApiEcosystemEcosystem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Alexa, Google Home, IFTTT, Aidoo... El slug no se debe cambiar.';
...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'FAQ de la portada y de soporte.';
...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Aviso legal, politica de privacidad y politica de cookies.';
...
export interface ApiNewsPostNewsPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog / novedades del sitio.';
    displayName: 'Noticia';
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Distribuidores oficiales B2B. El slug no se debe cambiar.';
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manuales, videos y tarjetas del centro de recursos. El slug no se debe cambiar: es la URL publica del recurso.';
    displayName: 'Recurso';
  ...
  attributes: {
    broken: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    type: Schema.Attribute.Enumeration<['manual', 'video', 'tarjeta']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Datos globales: contacto, redes y SEO por defecto.';
  ...
  attributes: {
    ...
    >;
    organizationDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    salesWhatsappMessage: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    siteName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'MySmartWindow'>;
    ...
    supportWhatsappMessage: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Las personas que salen en la pagina de equipo. El orden de la pagina lo fija el campo `order`, de menor a mayor.';
